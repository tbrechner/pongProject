...
weights = {
    '1': np.random.randn(num_nodes_hidden_layer, input_dimensions) / np.sqrt(input_dimensions),
    '2': np.random.randn(num_nodes_hidden_layer) / np.sqrt(num_nodes_hidden_layer)
}
